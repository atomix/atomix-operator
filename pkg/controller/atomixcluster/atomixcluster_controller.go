package atomixcluster

import (
	"context"

	agentv1alpha1 "github.com/atomix/atomix-operator/pkg/apis/agent/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &agentv1alpha1.AtomixCluster{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &agentv1alpha1.AtomixCluster{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileAtomixCluster) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &agentv1alpha1.AtomixCluster{}
	...
	// Set AtomixCluster instance as the owner and controller
...
func newPodForCR(cr *agentv1alpha1.AtomixCluster) *corev1.Pod {
