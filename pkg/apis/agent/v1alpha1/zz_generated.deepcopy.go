...
func (in *AtomixBenchmarkList) DeepCopyInto(out *AtomixBenchmarkList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]AtomixBenchmark, len(*in))
		for i := range *in {
...
func (in *AtomixBenchmarkStatus) DeepCopy() *AtomixBenchmarkStatus {
	if in == nil {
		return nil
	}
	out := new(AtomixBenchmarkStatus)
	in.DeepCopyInto(out)
	return out
}
